...
| Platform | File |
|---|---|
| Windows 10/11 (64-bit) | `ObserverLauncher-2.2.0-setup.exe` |
| Linux (AppImage) | `ObserverLauncher-2.2.0.AppImage` |

**Windows:** run the installer. It sets up auto-update.

**Linux:** `chmod +x ObserverLauncher-2.2.0.AppImage`, then run it. No root needed.
