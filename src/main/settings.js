...
function loadSettings() {
  try {
    ...
    return { version: latestVersion, serverPath: '', javaPath: '', memoryMin: min, memoryMax: max, jvmArgs: '', autoEula: true, onboarded: false, autoRestart: false, autoRestartMaxAttempts: 3, autoRestartDelaySeconds: 5, autoBackupMinutes: 0, backupRetention: 10, locale: 'en', scheduleEnabled: false, scheduleStartTime: '', scheduleStopTime: '', scheduleDays: [], mcpEnabled: false, mcpAutoAllowWrite: false, playitPath: '', autoTunnel: false };
  }
}
