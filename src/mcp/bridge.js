...
const STATIC_TOOLS = [
  ...
  ['list_content', 'Plugins, mods and datapacks (mods carry a loader flag).'],
  ...
  ['search_marketplace', 'Search Modrinth, Hangar or Spigot (pass loader to pin the loader).'],
  ...
  ['check_mod_compat', 'Scan mods/ for wrong-loader jars, missing required deps + conflicts.'],
  ['read_crash_report', 'Read a crash-report from crash-reports/ (server-rooted).'],
